...
public class UserController {
	...
	public Optional<UserModel> getUserByReqParam(@RequestParam UUID id){
	...
	public  String updateUserById(@RequestBody UserModel user, @RequestParam(required = true) UUID id){
	...
	public String deleteUserByReqParam(@RequestParam(required = true) UUID id){
